 ...
 * @author NITK
 */
public class MovieDetails1 extends javax.swing.JFrame {
   static String movie;
   static final String username = "root";
     ...
     */
    public MovieDetails1(String name) {
        initComponents();
        movie=name;
...
//b.setVisible(true);// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MovieDetails1  m= new  MovieDetails1(movie);
